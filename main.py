...
app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite://///home/sanjay/Desktop/AppSec2/database.db'
...
class LoginForm(FlaskForm):
    ...
    phonenumber = StringField('phonenumber', validators=[InputRequired(), Length(min=10, max=11)])
